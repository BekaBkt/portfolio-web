  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl w-full space-y-6">
        ...
        {/* Title & Tagline */}
        <div>
          <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight flex items-center justify-center gap-3">
            {ozzy.title}
            <span className="text-xs font-mono font-normal px-2.5 py-0.5 rounded-md bg-white/10 text-white/70 border border-white/10">v1.0</span>
          </h3>
